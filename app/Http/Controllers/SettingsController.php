...
class SettingsController extends Controller
{
    ...
    public function update(Request $request, CompanySettings $settings): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'cnpj.regex' => 'Informe um CNPJ válido com 14 números.',
            'postal_code.regex' => 'Informe um CEP válido com 8 números.',
            'state.regex' => 'Informe o estado usando a sigla com 2 letras.',
        ]);
