...
class ServiceOrder extends Model
{
    ...
    protected $fillable = ['number', 'client_id', 'equipment_type_id', 'manufacturer_id', 'equipment_description', 'attendance_type', 'status', 'reported_problem', 'received_at', 'completed_at', 'result', 'technical_report', 'final_report', 'subtotal_cents', 'discount_cents', 'total_cents', 'created_by'];
