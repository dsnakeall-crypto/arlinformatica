...
- [PENDENTE] Homologar no ambiente publicado PDFs timbrados com conteúdo extenso (muitos itens, garantias e fotos), conferindo quebra em múltiplas páginas, repetição do fundo e ausência de sobreposição com cabeçalho/rodapé.
