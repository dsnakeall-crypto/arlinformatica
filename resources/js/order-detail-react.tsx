...
export default function OrderDetailPage({ id, back, readOnly = false, reopenOnLoad = false, onEdit, onDirtyChange, onOpenClientHistory }: Props & { readOnly?: boolean }) {
  ...
  if (readOnly) return <div data-arl-order-detail-react="1" data-mobile-read-only="1" className="arl-mobile-read-only">
    <header className="arl-mobile-read-only-header"><button type="button" className="arl-back-button" onClick={back} aria-label="Voltar para OS abertas">←</button><div><span>ORDEM DE SERVIÇO</span><h1>OS #{order.number}</h1><span className="arl-order-markers">{reopened&&<span className="arl-reopened-marker arl-order-reopened-marker">Reaberta</span>}{closingMarker}</span>{interrupted&&<span className="arl-reopened-marker arl-interrupted-marker arl-order-reopened-marker">Interrompida</span>}</div></header>
  ...
  return <div data-arl-order-detail-react="1" className="arl-order-detail-page">
    <header className="arl-order-sticky-header">
      <div className="arl-order-header-main">
        ...
        <div className="arl-order-header-identity"><span className="arl-eyebrow">ORDEM DE SERVIÇO</span><h1>OS #{order.number}</h1><span className="arl-order-markers">{reopened&&<span className="arl-reopened-marker arl-order-reopened-marker">Reaberta</span>}{closingMarker}</span>{interrupted&&<span className="arl-reopened-marker arl-interrupted-marker arl-order-reopened-marker">Interrompida</span>}</div>
      </div>
