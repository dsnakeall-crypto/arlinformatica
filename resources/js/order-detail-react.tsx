  ...
  return <div data-arl-order-detail-react="1" className="arl-order-detail-page">
    ...
    <section className="panel arl-intake-card" aria-labelledby="arl-intake-title">
      ...
      <div className="arl-intake-grid">
        ...
        <section className="arl-intake-field arl-intake-equipment-field"><h3>Equipamento</h3><div><p className="arl-intake-equipment-name"><strong>{order.equipment_description || 'Equipamento não informado'}</strong></p>{order.equipment_details && <p className="arl-intake-equipment-details">{order.equipment_details}</p>}</div></section>
