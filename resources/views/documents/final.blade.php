...
<table class="final-summary"><tr><td></td><td class="label">Subtotal</td><td class="amount">R$ {{ number_format($finalization['subtotal_cents']/100, 2, ',', '.') }}</td></tr><tr><td></td><td class="label discount">Desconto</td><td class="amount discount">− R$ {{ number_format($finalization['discount_cents']/100, 2, ',', '.') }}</td></tr><tr><td></td><td class="label grand-total">VALOR TOTAL</td><td class="amount grand-total">R$ {{ number_format($finalization['total_cents']/100, 2, ',', '.') }}</td></tr></table>
@else
<table class="final-summary"><tr><td></td><td class="grand-total" colspan="2">VALOR TOTAL&nbsp;&nbsp;R$ {{ number_format($finalization['total_cents']/100, 2, ',', '.') }}</td></tr></table>
@endif
