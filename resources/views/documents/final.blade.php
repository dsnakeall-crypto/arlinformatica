...
<table class="final-summary"><tr><td class="warranty-text">@if($generalWarranty)<strong>Garantia:</strong> {!! nl2br(e($generalWarranty)) !!}@endif</td><td class="grand-total">VALOR TOTAL&nbsp;&nbsp;R$ {{ number_format($finalization['total_cents']/100, 2, ',', '.') }}</td></tr></table>
