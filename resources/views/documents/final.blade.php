...
.document-identity{display:table;width:100%;margin-bottom:7px;padding-bottom:6px;border-bottom:1px solid #dce6df;color:#087a43}.document-identity span,.document-identity strong{display:table-cell;vertical-align:middle}.document-identity span{font-size:9px;font-weight:700;text-transform:uppercase}.document-identity strong{text-align:right;font-size:13px}
</style>
@endsection
@section('content')
...
<div class="box checklist"><div class="section-title">Estado físico na entrada</div><p>{{ data_get($order, 'intake_condition') ?: 'Equipamento aparentemente 100% sem avarias' }}</p></div>
